...
{
    public class InsertLineCommand : BaseCommand
    {
        public InsertLineCommand(IExcelService excelService) : base(excelService)
        {
        ...
        public override void Execute(string[] args)
        {
            ...
            _excelService.UpdateCellsByLine(Convert.ToInt32(args[1]), Convert.ToInt32(args[2]),
